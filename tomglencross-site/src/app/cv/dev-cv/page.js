...
export default function DevCV() {
  ...
  return (
    ...
    <div className="text-3xl pl-4 py-3 space-y-0">
                ...
                <p className="pl-2 pb-3 text-lg"> My work is guided by experimentation and informed by elegant and accessible design principles, communicating emotions and ideas beyond just functionality.</p>
